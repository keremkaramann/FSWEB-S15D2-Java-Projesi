...
public class MainSetString {
    public static void main(String[] args) {
        ...
        String regex = "[.,?!\\\\n]";
        String wordsWithoutSpecChars = text.replaceAll(regex, "");
        String[] words = wordsWithoutSpecChars.split("\\s+");
        TreeSet<String> uniqueWords = new TreeSet<>(Arrays.asList(words));

        System.out.println("Original String: " + text);
        System.out.println("Orginal String size: " +text.length());
        System.out.println("String without special characters: " + wordsWithoutSpecChars);
        System.out.println("String without special characters size: " + uniqueWords.size());
